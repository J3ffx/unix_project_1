...
web()
{
	...
	while ((i!=$n+1))
		do
			...
			printf "<ul>" >> $2
			printf "<li><a href='%s'>bande-annonce</a></li>" "$tp1" >> $2 #bande annonce
			printf "<a href='%s'><img src='%s' /></a></li>" "$tp1" "$ta1" >> $2 #bande annonce dans l'image
			printf "<li>genre : %s</li>" "$g" >> $2 #genre
			printf "<li>synopsis : %s</li>" "$ta2" >> $2 #synopsis
			printf "<li>réalisateur(s) : %s</li>" "$ts2" >> $2 #réal
			printf "<li>acteurs/rôles : %s</li>" "$tt1" >> $2 #acteurs/roles
			printf "<li>durée : %s</li>" "$ts3" >> $2 #durée
			printf "<li>sortie le %s</li>" "$ts1" >> $2 #sortie
			printf "<li>notes : </li>" >> $2
			printf "<ul>" >> $2
			printf "<li>- %s/5</li>" "$ta3" >> $2 #note spec
			printf "<li>- %s/5</li>" "$ta4" >> $2 #note presse
			printf "<li>- %s/5</li>" "$tp3" >> $2 #note prem
			printf "<li>- %s/10</li>" "$ts4" >> $2 #note sens
			printf "</ul>" >> $2
			printf "</ul>" >> $2
			((i++))		
		done
